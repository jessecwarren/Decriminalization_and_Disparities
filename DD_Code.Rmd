...
UCR_arrest_totals_and_rates_with_pop <- UCR_arrest_totals_and_rates %>% 
  ungroup() %>% 
  dplyr::select(-STNAME) %>% 
  dplyr::select(year, State, City, ACS_city_name, AGENCY, GROUP, GEOID, UCR_pop = POP, total_popE, white_popE, white_popM, black_popE, black_popM, UCR_to_ACS_pop_ratio, 4:17)
...
UCR_arrest_totals_and_rates_with_pop <- UCR_arrest_totals_and_rates_with_pop %>% 
  ...
  mutate(total_violent_arrest_rate = total_violent_arrests / total_popE) %>% 
  mutate(marijuana_possession_arrest_rate = total_marijuana_possession_arrests_race_data / total_popE) %>% 
  mutate(marijuana_possession_and_sale_arrest_rate = total_marijuana_possession_and_sale_arrests_race_data / total_popE) %>% 
  ...
  mutate(white_marijuana_possession_arrest_rate = total_White_marijuana_possession_arrests / white_popE) %>% 
  mutate(black_marijuana_possession_arrest_rate = total_African_American_marijuana_possession_arrests / black_popE) %>%
  mutate(white_marijuana_possession_and_sale_arrest_rate = total_White_marijuana_possession_and_sale_arrests / white_popE) %>% 
  mutate(black_marijuana_possession_and_sale_arrest_rate = total_African_American_marijuana_possession_and_sale_arrests / black_popE) %>% 
...
ACS_common_support_data <- decriminilization_status_one_equals_any_legalization_in_year %>% 
  filter(year == 2016) %>% 
  left_join(ACS_common_support_data,  by = "State") %>% 
  rename(decriminalized_by_end_of_2016 = decriminilization_status_one_equals_any_legalization_in_year) %>% 
  dplyr::select(-year)
...
common_support_regression <- lm(decriminalized_by_end_of_2016 ~ log_total_pop +
...
max_probability_of_non_decriminalized_city <- max(ACS_common_support_data$probability_of_decriminilization[ACS_common_support_data$decriminalized_by_end_of_2016 == 0])   
min_probability_of_decriminalized_city <- min(ACS_common_support_data$probability_of_decriminilization[ACS_common_support_data$decriminalized_by_end_of_2016 == 1])
...
UCR_arrest_totals_and_rates_with_pop %>% 
  filter(ACS_city_name %in% common_support_cities) %>% 
  lm(marijuana_possession_arrest_rate ~ decriminilization_status_fraction_of_year_legalized +
       factor(City) +
       factor(Year) +
       pct_black +
       pct_in_poverty,
...
regression_function_no_cluster("marijuana_possession_arrest_rate", common_support_cities, "decriminilization_status_fraction_of_year_legalized")
regression_function_clustered("marijuana_possession_arrest_rate", common_support_cities, "decriminilization_status_fraction_of_year_legalized")

#marijuana arrest rate disparity, run on just common support cities
regression_function_no_cluster("marijuana_possession_arrest_rate_disparity", common_support_cities, "decriminilization_status_fraction_of_year_legalized")
regression_function_clustered("marijuana_possession_arrest_rate_disparity", common_support_cities, "decriminilization_status_fraction_of_year_legalized")

#black marijuana arrest rate, run on just common support cities
regression_function_no_cluster("black_marijuana_possession_arrest_rate", common_support_cities, "decriminilization_status_fraction_of_year_legalized")
regression_function_clustered("black_marijuana_possession_arrest_rate", common_support_cities, "decriminilization_status_fraction_of_year_legalized")

#nondrug misdemeanor arrest rate, run on just common support cities
regression_function_no_cluster("non_drug_misdemeanor_arrest_rate", common_support_cities, "decriminilization_status_fraction_of_year_legalized")
regression_function_clustered("non_drug_misdemeanor_arrest_rate", common_support_cities, "decriminilization_status_fraction_of_year_legalized")

#black nondrug  misdemeanor arrest rate, run on just common support cities
regression_function_no_cluster("black_non_drug_misdemeanor_arrest_rate", common_support_cities, "decriminilization_status_fraction_of_year_legalized")
regression_function_clustered("black_non_drug_misdemeanor_arrest_rate", common_support_cities, "decriminilization_status_fraction_of_year_legalized")

#nondrug misdemeanor arrest rate disparity, run on just common support cities
regression_function_no_cluster("non_drug_misdemeanor_arrest_rate_disparity", common_support_cities, "decriminilization_status_fraction_of_year_legalized")
regression_function_clustered("non_drug_misdemeanor_arrest_rate_disparity", common_support_cities, "decriminilization_status_fraction_of_year_legalized")
...
UCR_arrest_totals_and_rates_with_pop %>% 
  filter(City %in% cities_that_legalized_by_end_of_2016_vector) %>% 
  ggplot(aes(x = Year, )) +
  geom_line(aes(y = marijuana_possession_arrest_rate, group = City)) +
  facet_wrap(~State)
...
UCR_arrest_totals_and_rates_with_pop %>% 
  filter(City %in% cities_that_legalized_by_end_of_2016_vector) %>% 
  ggplot(aes(x = Year, )) +
  geom_line(aes(y = black_non_drug_misdemeanor_arrest_rate, group = City)) +
  facet_wrap(~State)
